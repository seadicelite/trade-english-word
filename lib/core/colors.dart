...
class sc {
  ...
  static const Color subttext = Color(0xFF9E9E9E);
  static const Color border = Color(0xFF2A2A2A);
  static const Color icon = Color(0xFFEEEEEE);
  static const Color back = Color(0xFF1F1F1F);
  static const Color appbar = Color(0xFF0E0E0E);
  static const Color button = Colors.black;
